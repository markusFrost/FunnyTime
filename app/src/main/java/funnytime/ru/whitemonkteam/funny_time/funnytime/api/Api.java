...
import funnytime.ru.whitemonkteam.funny_time.funnytime.utils.Utils;
import funnytime.ru.whitemonkteam.funny_time.funnytime.utils.WrongResponseCodeException;
...
public class Api {
    ...
    public ArrayList<Note> getNotes(Long uid, Collection<Long> nids, String sort, Long count, Long offset) throws IOException, JSONException {
   ...
   /* public String deleteNote(Long nid)
    {
    ...
    public long createNote(String title, String text, String captcha_key, String captcha_sid  ) throws IOException, JSONException, KException{
        Params params = new Params("notes.add");
        params.put("title", title);
        params.put("text", text);
        params.put("privacy", "0");
    ...
    //http://vk.com/dev/notes.add
    public void editNote(long note_id, String title, String text) throws IOException, JSONException, KException{
        Params params = new Params("notes.edit");
        params.put("title", title);
